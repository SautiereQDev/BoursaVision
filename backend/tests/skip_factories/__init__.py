...
class InvestmentFactory(factory.Factory):
    ...
    def create_apple(cls):
        ...
        return cls.create(
            ...
            current_price=MoneyFactory.create(
                amount=Decimal("150.00"), currency=Currency.USD
            ),
    ...
    def create_microsoft(cls):
        ...
        return cls.create(
            ...
            currency=Currency.USD,
            current_price=MoneyFactory.create(
                amount=Decimal("300.00"), currency=Currency.USD
            ),
...
class UserModelFactory(factory.Factory):
    ...
    class Meta:
        from src.boursa_vision.infrastructure.persistence.models.users import (
            User as UserModel,
        )
...
class InvestmentModelFactory(factory.Factory):
    ...
    class Meta:
        from src.boursa_vision.infrastructure.persistence.models.investment import (
            InvestmentModel,
        )
...
class PortfolioModelFactory(factory.Factory):
    ...
    class Meta:
        from src.boursa_vision.infrastructure.persistence.models.portfolios import (
