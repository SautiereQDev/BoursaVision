...
from src.boursa_vision.domain.entities.investment import (
    Investment,
    InvestmentSector,
    InvestmentType,
    MarketCap,
)
from src.boursa_vision.domain.entities.portfolio import Portfolio, Position
from src.boursa_vision.domain.entities.user import User, UserRole
from src.boursa_vision.domain.value_objects.money import Currency, Money
...
class InvestmentFactory(factory.Factory):
    ...
    # ID will be auto-generated by the Investment.create method
    ...
    current_price = factory.SubFactory(MoneyFactory)
    ...
    def create_apple(cls):
        ...
        return cls.create(
            ...
            current_price=MoneyFactory.create(amount=Decimal("150.00"), currency=Currency.USD),
    ...
    def create_microsoft(cls):
        ...
        return cls.create(
            ...
            exchange="NASDAQ",
            currency=Currency.USD,
            current_price=MoneyFactory.create(amount=Decimal("300.00"), currency=Currency.USD),
...
class UserModelFactory(factory.Factory):
    ...
    class Meta:
        from src.boursa_vision.infrastructure.persistence.models.users import User as UserModel
        model = UserModel
...
class InvestmentModelFactory(factory.Factory):
    ...
    class Meta:
        from src.boursa_vision.infrastructure.persistence.models.investment import InvestmentModel
...
class PortfolioModelFactory(factory.Factory):
    ...
    class Meta:
        from src.boursa_vision.infrastructure.persistence.models.portfolios import Portfolio as PortfolioModel
