...
from boursa_vision.application.dtos.base import (
    BaseDTO, 
    ASSET_SYMBOL_DESC, INVESTMENT_NAME_DESC, EXCHANGE_NAME_DESC,
    INVESTMENT_TYPE_DESC, INVESTMENT_SECTOR_DESC, MARKET_CAP_DESC,
    TRADING_CURRENCY_DESC, PORTFOLIO_NAME_DESC, USER_ID_DESC,
    AMOUNT_DESC, CURRENCY_CODE_DESC, QUANTITY_DESC,
    AVERAGE_PRICE_DESC, CURRENT_PRICE_DESC
)
...
class TestBaseDTO:
    ...
    def test_basedto_is_pydantic_model(self):
        ...
        try:
            ...
            pytest.skip("pydantic BaseModel not available or BaseDTO structure different")
    ...
    def test_basedto_imports_available(self):
        ...
        from boursa_vision.application.dtos.base import InvalidSymbolError, PriceRangeError
