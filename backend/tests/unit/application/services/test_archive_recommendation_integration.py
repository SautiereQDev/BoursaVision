...
class TestArchiveServiceRealImports:
    ...
    def test_archive_data_provider_import_and_init(self):
        ...
        # Arrange & Act
        try:
            from src.boursa_vision.application.services.archive_recommendation_service import ArchiveDataProvider
    ...
    def test_archive_enhanced_analyzer_import_and_init(self):
        ...
        # Arrange & Act
        try:
            from src.boursa_vision.application.services.archive_recommendation_service import ArchiveEnhancedAdvancedAnalyzer
    ...
    def test_patch_function_import_and_call(self):
        ...
        # Arrange & Act
        try:
            from src.boursa_vision.application.services.archive_recommendation_service import patch_investment_recommendation_service
    ...
    def test_enhanced_analyzer_live_data_priority(self):
        ...
        try:
            ...
            mock_original_analyzer.analyze_investment.assert_called_once_with("HIGH_SCORE_SYMBOL")
    ...
    def test_enhanced_analyzer_archive_fallback(self):
        ...
        try:
            ...
            with patch.object(enhanced_analyzer.archive_provider, 'get_market_data_for_symbol', return_value=mock_archive_data):
        ...
        try:
            ...
            with patch.dict('sys.modules', {
                'boursa_vision.application.services.investment_recommendation_service': 
                    Mock(InvestmentRecommendationService=mock_investment_service),
                'boursa_vision.application.services.advanced_analysis_service':
                    Mock(AdvancedInvestmentAnalyzer=mock_analyzer_service)
            }):
                # Act
                result = patch_investment_recommendation_service()
