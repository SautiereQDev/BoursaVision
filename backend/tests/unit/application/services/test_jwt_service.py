...
class TestCreateAccessToken:
    ...
    def test_create_access_token_success(self, jwt_service, user_data):
        ...
        payload = jwt.decode(token.token, jwt_service.secret_key, algorithms=[jwt_service.algorithm])
...
class TestCreateTokenPair:
    ...
    def test_create_token_pair_with_extra_claims(self, jwt_service, user_data):
        ...
        token_pair = jwt_service.create_token_pair(extra_claims=extra_claims, **user_data)
...
class TestVerifyAccessToken:
    ...
    def test_verify_access_token_success(self, jwt_service, valid_token):
        ...
        assert payload["role"] == UserRole.BASIC
    ...
    def test_verify_access_token_wrong_type(self, jwt_service):
        ...
        wrong_token = jwt.encode(payload, jwt_service.secret_key, algorithm=jwt_service.algorithm)
...
class TestValidateAccessToken:
    ...
    def test_validate_access_token_wrong_secret_returns_false(self, jwt_service, valid_token):
