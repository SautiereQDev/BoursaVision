...
class TestYFinanceDataFetcher:
    ...
    async def test_should_not_delay_when_enough_time_passed(self):
        ...
        # Given
        self.fetcher.last_request_time = datetime.now().timestamp() - 1.0  # 1 seconde dans le passé
    ...
    async def test_should_handle_empty_data_response(self):
        ...
        # Given & When & Then
        with patch('boursa_vision.application.services.market_data_cache_service.yf') as mock_yf:
            mock_ticker = Mock()
            mock_hist = Mock()
...
class TestMarketDataCacheService:
    ...
    def setup_method(self):
        ...
        self.service = MarketDataCacheService(
            ...
            timeline_repository=self.mock_repository
        )
    ...
    async def test_should_return_timeline_from_memory_cache(self):
        ...
        assert self.service.stats["cache_hits"] == 0  # Memory cache ne compte pas comme hit
    ...
    def test_should_track_statistics_correctly(self):
        ...
        assert self.service.stats["yfinance_requests"] == initial_stats["yfinance_requests"] + 1
    ...
    def test_should_convert_symbol_to_uppercase(self):
        ...
        timeline = MarketDataTimeline(symbol=lowercase_symbol.upper(), currency=self.test_currency)
...
class TestCachePerformance:
    ...
    def test_should_maintain_stats_consistency_under_load(self):
        ...
        # Then
        assert self.service.stats["cache_hits"] == initial_stats["cache_hits"] + operations
