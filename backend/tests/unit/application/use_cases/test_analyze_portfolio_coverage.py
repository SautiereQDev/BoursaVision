...
def analyze_portfolio_use_case(mock_repositories, mock_services):
    ...
    performance_analyzer, risk_calculator, technical_analyzer, signal_generator = mock_services
...
class TestAnalyzePortfolioCoverage:
    ...
    async def test_calculate_performance_without_model_dump(self, analyze_portfolio_use_case, mock_repositories):
    ...
    async def test_calculate_performance_with_benchmark_no_data(self, analyze_portfolio_use_case, mock_repositories):
    ...
    async def test_calculate_risk_metrics_no_market_data(self, analyze_portfolio_use_case, mock_repositories):
    ...
    def test_calculate_allocation_with_cash_balance_zero(self, analyze_portfolio_use_case, mock_repositories):
    ...
    def test_convert_portfolio_to_dto_with_mock_attributes(self, analyze_portfolio_use_case):
    ...
    async def test_handle_missing_portfolio_data(self, analyze_portfolio_use_case, mock_repositories):
    ...
    async def test_performance_calculation_edge_cases(self, analyze_portfolio_use_case, mock_repositories):
