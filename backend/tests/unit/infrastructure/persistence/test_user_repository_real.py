...
class TestUserRepositoryBasics:
    ...
    def test_user_repository_has_available_methods(self):
        ...
        available_methods = [method for method in dir(repo) if not method.startswith('_') and callable(getattr(repo, method))]
    ...
    def test_user_repository_mapper_has_to_persistence(self):
        ...
        assert hasattr(repo._mapper, 'to_persistence') or hasattr(repo._mapper, 'to_model')
