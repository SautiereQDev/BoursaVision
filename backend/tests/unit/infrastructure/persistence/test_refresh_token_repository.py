...
class TestRefreshTokenRepositoryModuleStructure:
    ...
    def test_refresh_token_repository_module_file_exists(self):
        ...
        repo_path = Path(__file__).parent.parent.parent.parent.parent / 'src' / 'boursa_vision' / 'infrastructure' / 'persistence' / 'repositories' / 'refresh_token_repository.py'
    ...
    def test_refresh_token_repository_module_has_docstring(self):
        ...
        assert 'Repository implementation for RefreshToken entity using SQLAlchemy' in content
...
class TestRefreshTokenRepositoryImports:
    ...
    def test_refresh_token_repository_imports_domain_components(self):
        ...
        assert 'from boursa_vision.domain.entities.refresh_token import RefreshToken as DomainRefreshToken' in content
        assert 'from boursa_vision.domain.repositories.refresh_token_repository import IRefreshTokenRepository' in content
        assert 'from boursa_vision.infrastructure.persistence.models.refresh_tokens import RefreshToken' in content
...
class TestSQLAlchemyRefreshTokenRepositoryClass:
    ...
    def test_refresh_token_repository_class_definition(self):
        ...
        assert 'class SQLAlchemyRefreshTokenRepository(IRefreshTokenRepository):' in content
...
class TestRefreshTokenRepositoryBasicOperations:
    ...
    def test_find_by_id_method(self):
        ...
        assert 'async def find_by_id(self, entity_id: UUID) -> Optional[DomainRefreshToken]:' in content
    ...
    def test_save_method(self):
        ...
        assert 'async def save(self, entity: DomainRefreshToken) -> DomainRefreshToken:' in content
    ...
    def test_update_method(self):
        ...
        assert 'async def update(self, entity: DomainRefreshToken) -> DomainRefreshToken:' in content
...
class TestRefreshTokenRepositorySpecializedQueries:
    ...
    def test_find_by_token_method(self):
        ...
        assert 'async def find_by_token(self, token: str) -> Optional[DomainRefreshToken]:' in content
    ...
    def test_find_by_user_id_method(self):
        ...
        assert 'async def find_by_user_id(self, user_id: UUID) -> List[DomainRefreshToken]:' in content
    ...
    def test_find_active_by_user_id_method(self):
        ...
        assert 'async def find_active_by_user_id(self, user_id: UUID) -> List[DomainRefreshToken]:' in content
        assert 'Find all active (non-revoked, non-expired) refresh tokens' in content
        assert 'RefreshToken.is_revoked == False' in content
    ...
    def test_revoke_all_for_user_method(self):
        ...
        assert 'async def revoke_all_for_user(self, user_id: UUID, reason: str = "logout_all") -> int:' in content
