...
class TestRepositoriesImport:
    ...
    def test_sqlalchemy_portfolio_repository_import_succeeds(self):
        ...
        # Act & Assert
        try:
            from boursa_vision.infrastructure.persistence import SQLAlchemyPortfolioRepository
    ...
    def test_sqlalchemy_market_data_repository_import_succeeds(self):
        ...
        # Act & Assert
        try:
            from boursa_vision.infrastructure.persistence import SQLAlchemyMarketDataRepository
...
class TestRepositoriesMethods:
    ...
    def test_user_repository_has_basic_methods(self):
        ...
        for method_name in basic_methods:
            assert hasattr(SQLAlchemyUserRepository, method_name), f"Missing method: {method_name}"
    ...
    def test_portfolio_repository_has_basic_methods(self):
        ...
        for method_name in basic_methods:
            assert hasattr(SQLAlchemyPortfolioRepository, method_name), f"Missing method: {method_name}"
    ...
    def test_market_data_repository_has_basic_methods(self):
        ...
        for method_name in basic_methods:
            assert hasattr(SQLAlchemyMarketDataRepository, method_name), f"Missing method: {method_name}"
...
class TestRepositoriesStructure:
    ...
    def test_market_data_repository_is_class(self):
        ...
        assert SQLAlchemyMarketDataRepository.__name__ == 'SQLAlchemyMarketDataRepository'
    ...
    def test_repositories_have_docstrings(self):
        ...
        # Act & Assert
        for repo_class in [SQLAlchemyUserRepository, SQLAlchemyPortfolioRepository, SQLAlchemyMarketDataRepository]:
