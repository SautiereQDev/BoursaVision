...
class TestCLIModuleStructure:
    ...
    def test_cli_module_file_exists(self):
        ...
        cli_path = Path(__file__).parent.parent.parent.parent.parent / 'src' / 'boursa_vision' / 'infrastructure' / 'background' / 'cli.py'
...
class TestCLIConstants:
    ...
    def test_cli_has_valid_periods(self):
        ...
        expected_periods = ['1d', '5d', '1mo', '3mo', '6mo', '1y', '2y', '5y', '10y', 'ytd', 'max']
