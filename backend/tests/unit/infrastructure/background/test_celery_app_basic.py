    ...
    def test_celery_app_module_import_succeeds(self):
        ...
        try:
            ...
            spec = importlib.util.spec_from_file_location(
                "celery_app", 
                "/home/quentin-sautiere/Documents/workspace/python/BoursaVision/backend/src/boursa_vision/infrastructure/background/celery_app.py"
            )
            ...
            import os
            celery_file = "/home/quentin-sautiere/Documents/workspace/python/BoursaVision/backend/src/boursa_vision/infrastructure/background/celery_app.py"
            assert os.path.exists(celery_file), f"Celery app file should exist: {celery_file}"
