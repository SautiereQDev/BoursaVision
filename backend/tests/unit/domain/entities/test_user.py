...
class TestUserDisplayProperties:
    ...
    def test_full_name_first_only(self):
        """Test full_name with only first name (last name is whitespace)"""
        user = User(
            email="test@example.com",
            username="testuser",
            first_name="John",
            last_name=" "  # Space will be stripped
        )
        
        assert user.full_name == "John"

    def test_full_name_last_only(self):
        """Test full_name with only last name (first name is whitespace)"""
        user = User(
            email="test@example.com",
            username="testuser",
            first_name=" ",  # Space will be stripped
            last_name="Doe"
        )
    ...
    def test_full_name_empty(self):
        """Test full_name with whitespace names (both will be stripped)"""
        user = User(
            email="test@example.com",
            username="testuser",
            first_name=" ",  # Space will be stripped
    ...
    def test_display_name_fallback_to_username(self):
        """Test display_name falls back to username when no names (using whitespace)"""
        user = User(
            email="test@example.com",
            username="johndoe",
            first_name=" ",  # Whitespace that will be stripped
            last_name=" "    # Whitespace that will be stripped
        )
