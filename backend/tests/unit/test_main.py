...
try:
    from boursa_vision.main import setup_paths, detect_environment, create_app, main
except ImportError:
...
class TestDetectEnvironment:
    ...
    def test_detect_environment_default_port(self):
        ...
        with patch("os.path.exists") as mock_exists, \
            ...
            mock_getenv.side_effect = lambda key, default=None: default  # Return default values
...
class TestCreateApp:
    ...
    def test_create_app_import_error(self, mock_print, mock_setup_paths):
        ...
        with patch("builtins.__import__", side_effect=ImportError("fastapi_yfinance not found")):
...
class TestMain:
    ...
    @patch("builtins.print")
    def test_main_docker_production_mode(self, mock_print, mock_uvicorn, mock_detect_env):
    ...
    @patch("boursa_vision.main.uvicorn.run")
    @patch("builtins.print")
    def test_main_docker_development_mode(self, mock_print, mock_uvicorn, mock_detect_env):
    ...
    @patch("boursa_vision.main.uvicorn.run")
    @patch("builtins.print")
    def test_main_local_development_mode(self, mock_print, mock_uvicorn, mock_detect_env):
    ...
    def test_main_prints_startup_messages(self, mock_print, mock_detect_env):
        ...
        with patch("boursa_vision.main.uvicorn.run"), \
            ...
            mock_print.assert_any_call("📖 Documentation disponible sur: http://0.0.0.0:8000/docs")
