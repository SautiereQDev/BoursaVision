...
def downgrade() -> None:
    ...
    op.execute(
        "ALTER TABLE portfolios DROP CONSTRAINT IF EXISTS check_portfolios_cash_reasonable;"
    )
    op.execute(
        "ALTER TABLE transactions DROP CONSTRAINT IF EXISTS check_transactions_price_positive;"
    )
    op.execute(
        "ALTER TABLE transactions DROP CONSTRAINT IF EXISTS check_transactions_amount_reasonable;"
    )
    op.execute(
        "ALTER TABLE positions DROP CONSTRAINT IF EXISTS check_positions_quantity_positive;"
    )
    ...
    op.execute(
        "ALTER TABLE notifications DROP CONSTRAINT IF EXISTS fk_notifications_alert_id;"
    )
    op.execute(
    ...
    op.execute(
        "ALTER TABLE fundamental_data DROP CONSTRAINT IF EXISTS fk_fundamental_data_instrument_id;"
    )
    op.execute(
        "ALTER TABLE transactions DROP CONSTRAINT IF EXISTS fk_transactions_portfolio_id;"
    )
    op.execute(
        "ALTER TABLE transactions DROP CONSTRAINT IF EXISTS fk_transactions_instrument_id;"
    )
    op.execute(
        "ALTER TABLE positions DROP CONSTRAINT IF EXISTS fk_positions_portfolio_id;"
    )
    op.execute(
        "ALTER TABLE positions DROP CONSTRAINT IF EXISTS fk_positions_instrument_id;"
    )
