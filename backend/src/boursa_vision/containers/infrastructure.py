...
class InfrastructureContainer(containers.DeclarativeContainer):
    ...
    redis_client = providers.Singleton(
        ...
        url=providers.Singleton(lambda: "redis://localhost:6379/0"),
    )
    ...
    celery_app = providers.Singleton(
        _create_celery_app,
        broker_url=providers.Singleton(lambda: "redis://localhost:6379/1"),
        result_backend=providers.Singleton(lambda: "redis://localhost:6379/2"),
    )
    ...
    email_service = providers.Factory(
        ...
        smtp_host=providers.Singleton(lambda: "localhost"),
        smtp_port=providers.Singleton(lambda: 587),
        smtp_username=providers.Singleton(lambda: "user@example.com"),
        smtp_password=providers.Singleton(lambda: "password"),
    )
