...
class BulkRefreshRequest(BaseModel):
    ...
    max_concurrent: int = Field(10, description="Nombre maximum de requêtes simultanées")
...
async def get_market_data(
    ...
    try:
        ...
        response_points = []
        for point in points:
            response_points.append(MarketDataPoint(
...
async def get_cache_statistics(
    ...
    try:
        ...
        performance_metrics = {
            ...
            "data_freshness": "optimal" if stats["cache_hit_rate"] > 80 else "suboptimal",
            "memory_efficiency": stats["timelines_in_memory"] / max(1, stats["total_requests"]) * 100
        }
