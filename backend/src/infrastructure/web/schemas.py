...
class PortfolioUpdate(BaseAPISchema):
    ...
    name: Optional[str] = Field(None, description="Portfolio name", min_length=1, max_length=100)
    description: Optional[str] = Field(None, description="Portfolio description", max_length=500)
...
class InvestmentCreate(BaseAPISchema):
    ...
    symbol: str = Field(..., description="Investment symbol", min_length=1, max_length=20)
...
class InvestmentRecommendation(BaseAPISchema):
    ...
    recommendation: str = Field(..., description="Recommendation type (BUY, SELL, HOLD)")
...
class InvestmentRecommendationsResponse(BaseAPISchema):
    ...
    recommendations: List[InvestmentRecommendation] = Field(..., description="List of recommendations")
