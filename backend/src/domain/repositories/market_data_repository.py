...
class IMarketDataRepository(ABC):
    ...
    @abstractmethod
    async def find_by_id(self, market_data_id: UUID) -> Optional[MarketData]:
    ...
    async def save(self, market_data: MarketData) -> MarketData:
        """Save market data (create or update)"""
        pass
    
    @abstractmethod
    async def save_batch(self, market_data_list: List[MarketData]) -> List[MarketData]:
        """Save multiple market data points efficiently"""
        pass
    
    @abstractmethod
    async def delete_by_id(self, market_data_id: UUID) -> bool:
